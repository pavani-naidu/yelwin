...
export const WorkSection: React.FC = () => {
  ...
  const categories = ['ALL', 'FINTECH PLATFORM', 'HEALTHCARE APP', 'BRAND IDENTITY', 'SAAS PRODUCT'];
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full md:w-auto">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 text-xs font-mono font-bold tracking-widest uppercase text-white hover:text-neutral-300 transition-colors group shrink-0 border border-neutral-800 bg-neutral-950 px-4 py-2.5"
            >
